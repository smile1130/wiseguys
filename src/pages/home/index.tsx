...
const Home = () => {
    ...
    return (
        <div className="bg-bgPrimary w-full pe-4 pb-4 max-sm:ps-4 flex flex-col">
            <div className="bg-black rounded-[10px] px-8 py-6 max-sm:hidden">
                <div className="flex items-start justify-between">
                    <div className="p-4 w-fit border border-[#181818] rounded-[10px]">
                        ...
                        <p className="text-32 text-[#00FF85] font-bold">
                            $50,000
                        </p>
                    </div>
                    <div className="p-4 w-fit border border-[#181818] rounded-[10px]">
                ...
                <div className="flex items-center justify-between px-12">
                    ...
                    <div className="flex items-center gap-16">
                        ...
                        <div className="text-20 text-white font-semibold">
                            VS
                        </div>
                        <div>
            ...
            {isSwapToken ? (
                ...
                <>
                    <div className="bg-black rounded-[10px] px-8 max-sm:px-4 py-6 max-sm:py-3 sm:hidden mt-3">
                        <span className="text-16 max-sm:text-14 font-medium text-[#BCBCBC]">
                            Betting Treasury Amount
                        </span>
                        <p className="text-32 text-[#00FF85] font-bold">
                            $50,000
                        ...
                        <div className="sm:p-4 w-fit sm:border border-[#181818] rounded-[10px] max-sm:float-right">
                            <span className="text-16 max-sm:text-12 font-medium text-[#BCBCBC] max-sm:float-right">
                                Voting Ends In
                            </span>
                            <br />
                            <p className="text-16 max-sm:text-14 text-white font-bold">
                                20 H : 50 M : 30 S
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 mt-6 max-sm:mt-3 w-full grow">
                        <div className="bg-black rounded-[10px] px-8 max-sm:px-4 py-6 max-sm:py-3 w-1/2">
                            <button className="text-white text-16 max-sm:text-14 font-bold bg-[#00A3FF] rounded-[7px] w-full py-2">
                                VOTE
                            </button>
                            <div className="flex max-sm:flex-col-reverse items-start gap-5">
                                <div className="sm:p-4 w-fit sm:border border-[#181818] rounded-[10px] mt-6">
                                    <span className="text-16 max-sm:text-14 text-[#BCBCBC]">
                                        Total Votes
                                    </span>
                                    <p className="text-16 text-white font-bold">
                                        51
                                ...
                                <div className="w-full text-white flex flex-col gap-5 justify-center items-center mt-6 p-2">
                                    <p className="text-14 max-sm:text-12 text-[#999999]">
                                        Percentage of Votes Favoring
                                    </p>
                                    <p className="text-64 max-sm:text-40 text-[#00FF85] font-bold">
                                        51%
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="bg-black rounded-[10px] px-8 max-sm:px-4 py-6 max-sm:py-3 w-1/2">
                            ...
                            <div className="flex max-sm:flex-col-reverse items-start gap-5">
                                ...
                                <div className="w-full text-white flex flex-col gap-5 justify-center items-center mt-6 p-2">
                                    ...
                                    <p className="text-64 max-sm:text-40 text-[#FF5959] font-bold">
                                        49%
                                    </p>
                                </div>
                            </div>
